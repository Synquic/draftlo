        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              {/* TRUST SIGNALS — directly under CTA for reassurance before payment */}
              ...
              {/* 24x7 WhatsApp Support — moved below all content so it doesn't compete with the primary CTA */}
              <div className="mt-6 pt-4 border-t border-gray-200">
                <a
                  href="https://wa.me/919019045647?text=Hi%20Draftlo%2C%20I%20have%20a%20question"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-sm font-medium text-green-700 hover:text-green-800 bg-green-50 hover:bg-green-100 border border-green-200 px-4 py-2 rounded-md transition"
                >
