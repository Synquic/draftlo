module.exports = [
"[project]/node_modules/mixpanel-browser/dist/mixpanel.module.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getUntaintedPrototype$1(key) {
    ...
    var isUntaintedMethods = Boolean(methodNames && methodNames.every(function(method) {
        var _a2;
...
function isShadowRoot(n2) {
    var hostEl = // but only shadow roots have a `mode` property
...
function stringifyRule(rule2, sheetHref) {
    if (isCSSImportRule(rule2)) {
        ...
        try {
            importStringified = stringifyStylesheet(rule2.styleSheet) || // work around browser issues with the raw string `@import url(...)` statement
        ...
        for(var i2 = 1; i2 < childNodes2.length; i2++){
            if (childNodes2[i2].textContent && typeof childNodes2[i2].textContent === "string") {
                ...
                for(; j < textContentNorm.length; j++){
                    if (textContentNorm[j].match(/[a-zA-Z0-9]/) || // substring needs to be unique to this section
...
function serializeArg(value, win, ctx) {
    ...
    } else if (// More info: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/SharedArrayBuffer/SharedArrayBuffer
...
var blob = ("TURBOPACK compile-time value", "undefined") !== "undefined" && window.Blob && new Blob([
 ...
 */ var RecordingRegistry = function(options) {
    /** @type {IDBStorageWrapper} */ this.idb = new IDBStorageWrapper(RECORDING_REGISTRY_STORE_NAME);
    this.errorReporter = options.errorReporter;
    ...
    return this.recordingRegistry.getActiveRecording().then((function(activeSerializedRecording) {
        if (activeSerializedRecording && !this.stopRecordingInProgress) {
            return this.startRecording({
                activeSerializedRecording: activeSerializedRecording
            });
        } else if (startNewIfInactive) {
            return this.startRecording({
                shouldStopBatcher: false
            });
        } else {
...
/** @const */ var LAYOUT_EVENTS = [
    EV_SCROLLEND
];
/** @const */ var NAVIGATION_EVENTS = [
    EV_HASHCHANGE
];
...
CONFIG_DEFAULTS$1[CONFIG_SCROLL_CHECKPOINTS] = [
    25,
    50,
    75,
    100
...
Autocapture.prototype._trackPageLeave = function(ev, currentUrl, currentScrollHeight) {
    ...
    this.mp.track(MP_EV_PAGE_LEAVE, props, {
...
FeatureFlagManager.prototype.getVariantValue = function(featureName, fallbackValue) {
    return this.getVariant(featureName, {
        'value': fallbackValue
...
FeatureFlagManager.prototype.getVariantValueSync = function(featureName, fallbackValue) {
    return this.getVariantSync(featureName, {
        'value': fallbackValue
    })['value'];
};
...
MixpanelPersistence.prototype.save = function() {
    ...
    this.storage.set(this.name, JSONStringify(this['props']), this.expire_days, this.cross_subdomain, this.secure, this.cross_site, this.cookie_domain);
};
 ...
 */ MixpanelLib.prototype._run_hook = function(hook_name) {
    ...
    _.each(this.hooks[hook_name], function(hook) {
        ...
        if (typeof ret === 'undefined') {
            ...
            hook_data.splice.apply(hook_data, [
                0,
                ret.length
            ].concat(ret));
        }
...
//# sourceMappingURL=node_modules_mixpanel-browser_dist_mixpanel_module_e682346d.js.map